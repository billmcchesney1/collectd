/**
 * collectd - src/utils_format_syslog.h
...
#ifndef UTILS_FORMAT_SYSLOG_H
#define UTILS_FORMAT_SYSLOG_H 1

#include "collectd.h"
#include "plugin.h"

#define SYSLOG_STORE_RATES        0x01

int format_syslog (char *buffer,
    size_t buffer_size, const data_set_t *ds,
    const value_list_t *vl, const char *prefix,
    const char *tags, const char escape_char,
    unsigned int flags);

#endif /* UTILS_FORMAT_SYSLOG_H */
